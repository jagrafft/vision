(function () {
	...
	var main$1 = function (sources) {
	    ...
	    var status = sources.ws.filter(function (x) { return x.req === "status"; });
	    var vdom_ = status.map(function (x) { return div(".w00t-list", [span(".w00t", ("status: " + (x.res)))]); });
	    return {
	        DOM: vdom_
	    }
	};
	...
	run(main$1, {
	    ...
	    ws: mkWsDriver("ws://localhost:12131")
	});
