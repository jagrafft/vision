(function () {
	...
	var status = function (str_) { return str_.filter(function (x) { return x.req === "status"; }).map(function (x) { return ("status: " + (JSON.stringify(x))); }); };
	var devices = function (str_) { return str_.filter(function (x) { return x.req === "queryDevices"; }).map(function (x) { return ("devices: " + (JSON.stringify(x.res))); }); };
