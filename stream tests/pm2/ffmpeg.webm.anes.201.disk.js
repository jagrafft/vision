...
//const addr = "rtsp://192.168.1.201:554/axis-media/media.amp?streamprofile=Streaming";
//const date = new Date();
const size = "640x360";
...
const cmd = prefix + "ffmpeg -y -thread_queue_size 2048 -f rtsp -rtsp_transport tcp -r 15 -i " + addr + " -c:v libvpx-vp9 -pix_fmt yuv420p -b:v 250k -s " + size + " -keyint_min 150 -g 150 -tile-columns 4 -frame-parallel 1 -an -f webm -dash 1 ~/left.webm";
